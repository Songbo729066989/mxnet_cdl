...
# This is the MXNet version of CDL used in the KDD 2016 hands-on tutorial for MXNet. 
# Note that the code is a simplified version of CDL and is used for demonstration only 
# (you can also find the corresponding IPython notebook). We do not use pretrain and 
# sigmoid activation (as used in the matlab/C++ code for CDL) in this version of code, 
